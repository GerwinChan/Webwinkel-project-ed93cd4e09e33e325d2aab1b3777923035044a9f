...
<html>
    ...
    <body>
       ...
       <nav>
        <div id='cssmenu'>
            <a href="indexcreate.php"><input type="image" src="Afbeeldingen/sign_in_button.png" id="button2" value="Log in"</a>
                <ul class="knoppen">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="Afbeeldingen/men.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="Afbeeldingen/womenBannerFrics.png" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="Afbeeldingen/underwear.png" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="Afbeeldingen/shoe.jpg" />
            </div>
             <div data-p="112.50" style="display: none;">
                <img data-u="image" src="Afbeeldingen/ass.jpg" />
            </div>
